...
%%% @doc
%%% The base_execution module defines the api for the execution sector
%%% of an BASE agent.
%%% @end
%%% ====================================================================================== %%%
%%% ====================================================================================== %%%
...
%% @doc get the schedule data of a task that is currently executing
...
%% @doc get the execution data of a task that is currently executing
...
%% @doc put the execution data of a task that is currently executing
-spec put_task_data(Shell::task_shell(),Data::term(), BH :: base_handle()) -> ok.
put_task_data(Data, Shell,BH) ->
  e:put_task_data(Data, Shell,BH) .
