...
%%%-------------------------------------------------------------------
-module(ps_fta_machine_servant_link_rp).
-author("LENOVO").
...
start_reflection(PluginState, ReflectorHandle, BH) ->
  ...
  TaskList = base_attributes:read(<<"TaskDurationList">>,<<"ps_fta">>,BH),

  {Average,NewList} = myFuncs:update_list_and_average(TaskList,Duration),

  base_attributes:write(<<"TaskDurations">>,<<"ps_fta">>,Average,BH),
  base_attributes:write(<<"TaskDurationList">>,<<"ps_fta">>,NewList,BH),
