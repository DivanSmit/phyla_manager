...
%%%-------------------------------------------------------------------
-module(pt_fta_machine_servant_link_rp).
-author("LENOVO").
...
start_reflection(PluginState, ReflectorHandle, BH) ->
  ...
  TaskList = base_attributes:read(<<"TaskDurationList">>,<<"pt_fta">>,BH),

  {Average,NewList} = myFuncs:update_list_and_average(TaskList,Duration),

  base_attributes:write(<<"TaskDurations">>,<<"pt_fta">>,Average,BH),
  base_attributes:write(<<"TaskDurationList">>,<<"pt_fta">>,NewList,BH),
