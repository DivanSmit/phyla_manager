...
%%%-------------------------------------------------------------------
-module(ps_operator_servant_link_rp).
-author("LENOVO").
...
start_reflection(PluginState, ReflectorHandle, BH) ->
  ...
  TaskList = base_attributes:read(<<"TaskDurationList">>,<<"ps_operator">>,BH),

  {Average,NewList} = myFuncs:update_list_and_average(TaskList,Duration),

  base_attributes:write(<<"TaskDurations">>,<<"ps_operator">>,Average,BH),
  base_attributes:write(<<"TaskDurationList">>,<<"ps_operator">>,NewList,BH),
