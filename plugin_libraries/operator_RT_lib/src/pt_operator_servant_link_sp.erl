...
%%%-------------------------------------------------------------------
-module(pt_operator_servant_link_sp).
-author("LENOVO").
...
init(Pars, BH) ->
  base_attributes:write(<<"TaskDurations">>,<<"pt_operator">>,1800000,BH),
  base_attributes:write(<<"TaskDurationList">>,<<"pt_operator">>,[1800000],BH),
  ok.
...
generate_proposal(Requirements, PluginState, NegH, BH) ->
  TaskDuration = base_attributes:read(<<"TaskDurations">>, <<"pt_operator">>, BH),
